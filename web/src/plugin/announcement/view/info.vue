  ...
  <div>
    ...
    <div class="gva-table-box">
      <div class="gva-btn-list">
        ...
        <el-button  style="margin-left: 10px;" :disabled="!multipleSelection.length" @click="onDelete">
          删除
        </el-button>
      </div>
      <el-table
      ...
      >
        ...
        <el-table-column align="left" label="操作" fixed="right" min-width="240">
          <template #default="scope">
            <el-button type="primary" link  class="table-button" @click="updateInfoFunc(scope.row)">
              变更
            </el-button>

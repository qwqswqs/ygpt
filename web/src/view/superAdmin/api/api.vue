  ...
  <div>
    ...
    >
      ...
      >
        ...
        >
          <template #default="{row}">
            <el-button  type="primary" link @click="addApiFunc(row)">
              单条新增
            </el-button>
            <el-button  type="primary" link @click="ignoreApiFunc(row,true)">
              忽略
            </el-button>
          </template>
        </el-table-column>
      ...
      >
        ...
        >
          <template #default="{row}">
            <el-button  type="primary" link @click="ignoreApiFunc(row,false)">
              取消忽略
            </el-button>
          </template>
        </el-table-column>

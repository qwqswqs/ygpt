          ...
          <template v-for="(item,k) in config.mongo.hosts">
            <el-form-item :label="`节点 ${k+1}`">
              ...
              <el-form-item v-if="k > 0">
                <el-button type="primary" size="small" plain :icon="Minus" @click="removeNode(k)" class="ml-3"/>
              </el-form-item>
            </el-form-item>
          </template>
          <el-form-item>
            <el-button type="primary" size="small" plain @click="addNode"/>
          </el-form-item>
        </el-tab-pane>
        <el-tab-pane
            label="验证码配置"
...
<script setup>
import { getSystemConfig, reloadSystem, setSystemConfig } from '@/api/system/system'
import { ref } from 'vue'
import { ElMessage, ElMessageBox } from 'element-plus'
import { Minus, Plus } from '@element-plus/icons-vue'
import { emailTest } from '@/api/system/email'

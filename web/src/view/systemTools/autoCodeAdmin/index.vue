  ...
  <div>
    <div class="gva-table-box">
      <div class="gva-btn-list">
        <el-button type="primary"  @click="goAutoCode(null)">
          新增
        </el-button>
      </div>
      <el-table :data="tableData":header-cell-style="{ 'background-color': 'rgba(242, 243, 245, 1)','color': 'rgba(29, 33, 41, 1)','text-align':'left'}">
        ...
        >
          <template #default="scope">
            <el-tag v-if="scope.row.flag" type="primary" effect="dark">
              已回滚
            </el-tag>
...
<script setup>
import { getSysHistory, rollback, delSysHistory,addFunc } from "@/api/system/autoCode.js";

<template>
  <div class="gva-form-box">
    ...
    <div class="info">
      <el-row :gutter="32" class="info">
        <el-col :lg="8" :sm="24" :xs="24">
          <el-card class="cpu-usage-card">
            <div style="width: 100%"><span>我的云主机</span></div>
        ...
        <el-col :lg="8" :sm="24" :xs="24">
          <el-card class="cpu-usage-card">
            <div style="width: 100%"><span>我的裸金属</span></div>
            <div class="card-content">
              <div class="cpu-value">
                <span class="value">8</span>
                <span class="unit">台</span>
        ...
        <el-col :lg="8" :sm="24" :xs="24">
          <el-card class="cpu-usage-card">
            <div style="width: 100%"><span>我的容器</span></div>
            <div class="card-content">
              <div class="cpu-value">
                <span class="value">8</span>
...
<script setup>
import {setSelfInfo, changePassword} from '@/api/system/user.js'

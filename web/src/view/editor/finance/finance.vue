<template>
  <div style="padding: 24px;margin-top: 16px;background-color: white">
    ...
    <el-drawer v-model="detailVisible" :show-close="false" size="30%">
      ...
      <el-descriptions v-if="specJson.length>0" label-width="100">
      ...
      <div class="flex" style="justify-content: right;margin-top: 24px">
        <el-button @click="detailVisible=false" type="info">关闭</el-button>
      </div>
    </el-drawer>
  </div>
</template>

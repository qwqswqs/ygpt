    ...
    <div class="gva-table-box">
      ...
      >
        ...
        <el-table-column label="操作">
          <template #default="scope">
            <el-button type="text" link @click="handleDownload(scope.row)">下载</el-button>
            <el-button type="text" link @click="handleShowHis(scope.row)">使用记录</el-button>
...
<!--      新增镜像-->
      ...
      >
        ...
        >
          ...
          <el-form-item label="文件上传" prop="fileInfo">
...
export default {
  ...
  methods: {
    ...
    getFileData() {
      ...
      this.dataInfo.fileInfo = inputFile
    },
    handleSearch() {
      this.GetImageList()
    },
        ...
        if (valid) {
          addBackImage(this.dataInfo).then(response => {
            if (response.code == 0) {
              ...
              obj.file=this.dataInfo.fileInfo

...
var renterService = service.ServiceGroupApp.YunGuanServiceGroup.RenterServiceGroup.RenterService
...
func (b *BaseApi) TokenNext(c *gin.Context, user system.SysUser) {
	...
	if !global.GVA_CONFIG.System.UseMultipoint {
		userService.UpdateOpsUserLoginTime(user.GetUserId())
		renterService.UpdateRenterLoginTimeService(user.GetUserId())

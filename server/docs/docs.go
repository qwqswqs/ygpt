    ...
    "paths": {
        ...
        "/soft/info/addSoftwareInfo": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "添加系统运行工具",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/software.SoftwareInfo"
                        }
                    }
                ],
                "responses": {}
    ...
    "definitions": {
        ...
        "config.Server": {
            ...
            "properties": {
                ...
                "email": {
                    "$ref": "#/definitions/ygpt_server_config.Email"
                },
                "excel": {
        ...
        "software.SoftwareInfo": {
            ...
            "properties": {
                ...
                "lastUpdate": {
                    "description": "LastUpdate 最后更新一次时间",
                    "type": "string"
                },
                "name": {
                    "description": "Name 软件名称",
                    "type": "string"
                },
                "size": {
                    "description": "Size 大小",

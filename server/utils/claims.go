...
func GetUserIDtoI64(c *gin.Context) int64 {
	id := GetUserID(c)
	return int64(id)
}
func GetUserIDtoI64Pointer(c *gin.Context) *int64 {
	id := GetUserID(c)
	i64 := int64(id)
	return &i64
}
func GetUserIDtoInt(c *gin.Context) int {
	id := GetUserID(c)
	return int(id)
}
func GetUserIDtoIntPointer(c *gin.Context) *int {
	id := GetUserID(c)
	idInt := int(id)
	return &idInt
}
func GetUserIDInt(c *gin.Context) *uint {
	userId := GetUserID(c)
	return &userId
}

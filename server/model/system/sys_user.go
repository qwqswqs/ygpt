...
type SysUser struct {
	...
	CompanyName   string         `json:"companyName" gorm:"column:company_name;type:text;comment:'公司名'"`                                     // 用户登录密码
	...
	LoginTime     time.Time      `json:"loginTime" gorm:"default:null;comment:'登录时间'"`
	Source        int            `json:"source" gorm:"default:1;comment:'用户来源：1本地注册 2算力注册'"`
}
